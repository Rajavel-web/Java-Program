...
public class OperatorsExamples {
	...
	public static void main(String[] args) {
		...
		OperatorsExamples  Arith =new OperatorsExamples();
		Arith.ArithmeticOperators();
		
		OperatorsExamples Assign=new  OperatorsExamples();
		
		Assign.AssignmentOperators();
		 
		OperatorsExamples Relation=new OperatorsExamples();
		
		Relation.RelationOperators();
           
		OperatorsExamples Logical=new  OperatorsExamples();
		
		Logical.LogicalOperators();
		
		OperatorsExamples ID=new  OperatorsExamples();
		
		ID.incrementdecrement();
		
		OperatorsExamples instance=new  OperatorsExamples();
		 
		instance.instance();
		
		OperatorsExamples bit =new  OperatorsExamples();
        bit.Bitwise();
		
		OperatorsExamples Ternary =new  OperatorsExamples();
		Ternary.Ternary();
